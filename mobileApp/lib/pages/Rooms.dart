...
import 'package:learnlign/pages/About.dart';
...
class _RoomsState extends State<Rooms> with SingleTickerProviderStateMixin {
  ...
  List<Map<String, dynamic>> _connectedUsers =
      []; // List of connected user details
  ...
  Future<void> _fetchConnections() async {
    ...
    List<Future<DocumentSnapshot>> userFutures = connectionUIDs
              ...
              child: Column(
                children: [
                        ...
                        tabs: const [
                          ...
                          Tab(
                            child: Row(
                              children: [
                                Icon(
                                  FluentIcons.branch_request_20_filled,
                                  size: 23,
                                ),
                                SizedBox(
                                  width: 3,
                  ...
                  Expanded(
                    child: TabBarView(
                      controller: _tabController,
                      children: [grouplist(), connectionlist(), pendingList()],
                    ),
                  ),
                ],
              ),
            ...
            child: Column(
              ...
              children: [
                ...
                Padding(
                  ...
                  child: Text(
                    'No chats and no connections ! \n You can connect people within your rooms',
                    style: TextStyle(
                      color: Colors.white70,
                      fontFamily: 'Quicksand',
                      fontWeight: FontWeight.bold,
        ...
        if (snapshot.hasData) {
          ...
          return Center(
            child: SpinKitFoldingCube(
              // Replace SpinKitCircle with any other available spinner
            ...
            child: Column(
              ...
              children: [
                ...
                Padding(
                  padding: const EdgeInsets.all(8.0),
                  child: Text(
                    '*You can provide a description about your room',
                    style: TextStyle(color: Colors.white70),
                  ),
                ),
                SizedBox(
